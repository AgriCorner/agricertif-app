    ...
    <div style={{ flex:1, overflowY:'auto', padding:'16px 14px 24px', background:G.bg }}>
      <div style={{ background:`linear-gradient(135deg, ${G.dark}, ${G.primary})`, borderRadius:16, padding:'20px 18px', marginBottom:16, display:'flex', gap:14, alignItems:'center' }}>
        ...
        <div>
          ...
          <div style={{ fontSize:12, color:'rgba(255,255,255,0.5)', marginTop:2 }}>Commercial agricole · AgriCorner</div>
...
══════════════════════════════════ */
function HomeScreen({ tab, setTab, onOpenVehicle, onOpenVehicleTab, onOpenCompany, onLaunchChecklist, onCreateNewInspection }) {
  return (
...
export default function App() {
  ...
  const [homeTab,      setHomeTab]      = useState('inspection');
